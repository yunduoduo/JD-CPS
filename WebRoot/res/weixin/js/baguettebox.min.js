var baguetteBox = function() {
    ...
    function names(M){
    	...
    	$(".gallery .image").click(function(){
    		$("#baguetteBox-overlay img").click(function(){
    			$("#baguetteBox-overlay").css("display","none");
    		});
    		var sPic = $(this).attr("sPic");
    		$("#baguetteBox-overlay .full-image:eq("+M+")").html("<figure><div class='spinner'></div><img src="+sPic+"></figure>");
    	});
    ...
    function r(t, e) {
        ...
        if ("undefined" != typeof n) {
            ...
            var i = y("figure")
              ...
              , a = y("figcaption");
            n.appendChild(i),
            i.innerHTML = '<div class="spinner"></div>',
            o.onload = function() {
    ...
    var b, k, w, C, T, N, E = '<svg width="44" height="60"><polyline points="30 10 10 30 30 50" stroke="rgb(255,255,255)" stroke-width="4"stroke-linecap="butt" fill="none" stroke-linejoin="round"/></svg>', x = '<svg width="44" height="60"><polyline points="14 10 34 30 14 50" stroke="rgba(255,255,255)" stroke-width="4"stroke-linecap="butt" fill="none" stroke-linejoin="round"/></svg>', B = '<svg width="30" height="30"><g stroke="rgb(0,189,229)" stroke-width="2"><line x1="5" y1="5" x2="17" y2="17"/><line x1="5" y1="17" x2="17" y2="5"/></g></svg>', I = {}, P = {
        captions: !0,
        buttons: "auto",
        async: !1,
        preload: 2,
