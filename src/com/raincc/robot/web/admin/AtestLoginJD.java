...
public class AtestLoginJD {  
    ...
    private static String LOGIN_NAME = "13810259504";  
    private static String LOGIN_PSW = "tianke111111";  
    private static String AuthCodeImgPath ="F:/test/"+ 123+".jpg";
//    static {  
