...
public class OrderTest {
	...
	private final static String OrderPage="https://media.jd.com/gotoadv/goods";//订单页面
	
	private final static String OrderUrl="https://media.jd.com/gotoadv/goods";//真实的订单数据请求
	...
	public JsonArray getUserOrder(String cookie,int year){
		...
		Elements elements  =  doc.select(".collapse");
		String aString = elements.select(".hidden-sm li a:first-child").html();
